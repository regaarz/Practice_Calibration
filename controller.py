...
class MainWindow(QMainWindow):
    ...
    def load_calibration_data(self):
        ...
        for file in files:
            ...
            if ret:
                ...
                corners2 = cv.cornerSubPix(grayScale, corners, (11, 11), (-1, -1), self.criteria)  # Menyesuaikan ukuran jendela
    ...
    def calibrate_camera(self):
        ...
        if not camMatrix:
            QMessageBox.critical(self, "Error", "No images found for calibration.")
            return
            ...
            if self.camera_started:
                ...
                if ret:
                    ...
                    if ret:
                        ...
                        cv.imwrite(f"{self.image_dir_path}/image_{self.image_counter}.png", frame)
                        print(f"Captured image_{self.image_counter}.png")
    ...
    def update_frame(self):
        if self.cap is not None and self.cap.isOpened():
            ...
            if ret:
                ...
                ret, corners = cv.findChessboardCorners(gray, self.CHESS_BOARD_DIM)
                if ret:
                    corners = cv.cornerSubPix(gray, corners, (3, 3), (-1, -1), self.criteria)  # Menyesuaikan ukuran jendela
                    frame = cv.drawChessboardCorners(frame, self.CHESS_BOARD_DIM, corners, ret)
